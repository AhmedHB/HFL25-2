// lib/display/hero_display_recruit.dart
...
Future<HeroModel> recruitNewHero() async {
  ...
  // Powerstats
  final int intelligence = readNumberWithRange('Ange intelligens (1–100)', 1, 100);
  final int strength = readNumberWithRange('Ange styrka (1–100)', 1, 100);
  final int speed = readNumberWithRange('Ange hastighet (1–100)', 1, 100);
  final int durability = readNumberWithRange('Ange uthållighet (1–100)', 1, 100);
  final int power = readNumberWithRange('Ange kraft (1–100)', 1, 100);
  final int combat = readNumberWithRange('Ange stridsskicklighet (1–100)', 1, 100);
